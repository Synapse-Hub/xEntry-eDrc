    ...
    public partial class frmUtilisateur : Form
    {
                ...
                try
                {
                    ...
                    if (bdsrcModifie.Count != 0)
                    {
                        ...
                        foreach (DataColumn dtc in ((DataRowView)bdsrcModifie.Current).Row.Table.Columns)
                        {
                            ...
                            else if (dtc.ToString().Equals("motpass")) { txtOldMotPasse.Text = ImplementChiffer.Instance.Decipher(((string)obj[i]), "rootWWF"); olPwd = ImplementChiffer.Instance.Cipher(((string)obj[i]), "rootWWF"); }
                            ...
                            else if (dtc.ToString().Equals("id_utilisateur")) { id_utilisateur = ((int)obj[i]); utilisateur.Id_utilisateur = ((int)obj[i]); }
                            else if (dtc.ToString().Equals("id_agentuser")) { id_agentuser = ((string)obj[i]); utilisateur.Id_agentuser = ((string)obj[i]); }
        ...
        private void dgv_SelectionChanged(object sender, EventArgs e)
        {
            try
            {
                if (bdsrcAffiche.Count != 0)
                {
                    ...
                    {
                        if (dtc.ToString().Equals("id_utilisateur")) id_utilisateur = ((int)obj[i]);
                        else if (dtc.ToString().Equals("id_agentuser")) id_agentuser = ((string)obj[i]);
                        i++;
                    }
        ...
        private void cmdModifierCompte_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    clstbl_utilisateur user = new clstbl_utilisateur();
                    Object[] obj = ((DataRowView)bdsrcModifie.Current).Row.ItemArray;
                    int i = 0;
                    foreach (DataColumn dtc in ((DataRowView)bdsrcModifie.Current).Row.Table.Columns)
                    {
                        ...
                        else if (dtc.ToString().Equals("motpass"))
                        {
                            ...
                            {
                                clsDoTraitement.oldPassword = ImplementChiffer.Instance.Decipher(((string)obj[i]), "rootWWF");
                        ...
                        else if (dtc.ToString().Equals("id_utilisateur")) user.Id_utilisateur = ((int)obj[i]);
                        else if (dtc.ToString().Equals("id_agentuser")) user.Id_agentuser = ((string)obj[i]);
                        else if (dtc.ToString().Equals("schema_user")) user.Schema_user = ((string)obj[i]);
                        i++;
                    }

                    user.Activation = chkActivationUserModi.Checked;
                    clsDoTraitement.activationUser = (bool)user.Activation;
                    ...
                    if (rdUserSeul.Checked)
                    {
                        ...
                        if (!txtNewUser.Text.Equals(""))
                        {
                            ...
                            new clstbl_utilisateur().update(user);
