...
-- WIN-BD3H4LSIL2E\SHSQLSERVER
/** Server name :: ECOMSERVER\CDSERVWWF_EDRC **/
...
CREATE TABLE tbl_fiche_tar(
	...
	photo_terrain image,
	emplacement  varchar(255), --geopoint
...
(
	...
	emplacement varchar(255), --geopoint
	photo_2 varchar(255),
	emplacement_2 varchar(255), --geopoint
...
(
	...
	total_plantules_observees float, -- note
...
CREATE TABLE tbl_fiche_suivi_pepi
(
	idFicheSuiviPep int identity(1,1),
	uuid varchar(100) NOT NULL,
	deviceid varchar(100) NOT NULL,
	date datetime NOT NULL,
	agent varchar(255),
...
-- TABLE ALTER
/****** Table TAR ******/
ALTER TABLE [dbo].[tbl_fiche_tar]  WITH CHECK ADD PRIMARY KEY([id])
GO
ALTER TABLE [dbo].[tbl_fiche_tar] ADD CONSTRAINT uuid_unique1 UNIQUE (uuid)
GO
/****** Table Ident Pepi ******/
ALTER TABLE [dbo].[tbl_fiche_ident_pepi]  WITH CHECK ADD PRIMARY KEY(idFichePep)
GO
ALTER TABLE [dbo].[tbl_fiche_ident_pepi] ADD CONSTRAINT uuid_unique6 UNIQUE (uuid)
GO
/****** Table Suivi Pepiniere ******/
ALTER TABLE [dbo].[tbl_fiche_suivi_pepi]  WITH CHECK ADD PRIMARY KEY(idFicheSuiviPep)
GO
ALTER TABLE [dbo].[tbl_fiche_suivi_pepi] ADD CONSTRAINT uuid_unique2 UNIQUE (uuid)
GO
/****** Table GEO ******/
ALTER TABLE [dbo].[tbl_geopoint]  WITH CHECK ADD PRIMARY KEY([id])
GO
/****** Table Menage ******/
ALTER TABLE [dbo].[tbl_fiche_menage]  WITH CHECK ADD PRIMARY KEY([id])
GO
ALTER TABLE [dbo].[tbl_fiche_menage] ADD CONSTRAINT uuid_unique4 UNIQUE (uuid)
GO
/****** Table PR ******/
ALTER TABLE [dbo].[tbl_fiche_pr]  WITH CHECK ADD PRIMARY KEY([id])
GO
ALTER TABLE [dbo].[tbl_fiche_pr] ADD CONSTRAINT uuid_unique5 UNIQUE (uuid)
GO
